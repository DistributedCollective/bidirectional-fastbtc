...
const TestPeer_1 = require("./TestPeer");
const TestTransport_1 = require("./TestTransport");
var ConnectionType;
...
class TestNetwork {
    ...
    getNode(id) {
        ...
        if (!info) {
            const transport = new TestTransport_1.TestTransport();
    ...
    getConnection(a, b) {
        ...
        if (!info) {
            const [aPeer, bPeer] = TestPeer_1.peersBetween(aInfo.id, bInfo.id);
            info = {

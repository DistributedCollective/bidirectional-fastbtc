...
exports.SynchronizedValues = void 0;
 ...
 * ```
 */
class SynchronizedValues {
    constructor(group, name, options) {
        var _a, _b;
        this.group = group;
        this.name = name;
        this.debug = new Debugger_1.Debugger(this, 'ataraxia:' + group.name + ':state:' + name);
        this.nodes = new Map();
...
exports.SynchronizedValues = SynchronizedValues;

...
const SharedGroup_1 = require("./SharedGroup");
/**
...
class GroupManager {
    constructor(net) {
        this.net = net;
        this.groups = new Map();
        this.debug = debug_1.default('ataraxia:' + net.name + ':groups');
    ...
    ensureSharedGroup(id) {
        ...
        if (!group) {
            group = new SharedGroup_1.SharedGroup(this.net.name, id, async (active) => {
                if (active) {

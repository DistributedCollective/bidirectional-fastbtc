...
class TopologyNode {
    constructor(parent, id) {
        ...
        this.incoming = [];
        this.version = 0;
        this.reachableVia = new id_1.IdSet();
        this.searchCost = 0;
     ...
     */
    get outgoingDebug() {
        return this.outgoing.map(e => ataraxia_transport_1.encodeId(e.target.id));
    }
    /**
     ...
     */
    get reachableDebug() {
        return Array.from(this.reachableVia.values()).map(e => ataraxia_transport_1.encodeId(e));
    }
    /**
...
exports.TopologyNode = TopologyNode;

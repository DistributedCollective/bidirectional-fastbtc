...
class Network {
    ...
    constructor(options) {
        ...
        this.debug = new Debugger_1.Debugger(this, debugNamespace);
        this.networkIdBinary = ataraxia_transport_1.generateId();
        this.name = options.name;
        this.endpoint = options.endpoint || false;
        __classPrivateFieldSet(this, _Network_transports, [], "f");
        __classPrivateFieldSet(this, _Network_active, false, "f");
        __classPrivateFieldSet(this, _Network_nodeAvailableEvent, new atvik_1.Event(this), "f");
        __classPrivateFieldSet(this, _Network_nodeUnavailableEvent, new atvik_1.Event(this), "f");
        __classPrivateFieldSet(this, _Network_messageEvent, new atvik_1.Event(this), "f");
        __classPrivateFieldSet(this, _Network_nodes, new Map(), "f");
        this.services = new Map();
        // Setup the topology of the network
        __classPrivateFieldSet(this, _Network_topology, new topology_1.Topology(this, options), "f");
        __classPrivateFieldGet(this, _Network_topology, "f").onAvailable(n => {
            const node = new NetworkNode_1.NetworkNode(debugNamespace, __classPrivateFieldGet(this, _Network_topology, "f"), n.id);
        ...
        __classPrivateFieldGet(this, _Network_topology, "f").onUnavailable(n => {
            const encodedId = ataraxia_transport_1.encodeId(n.id);
        ...
        __classPrivateFieldGet(this, _Network_topology, "f").onData((id, type, data) => {
            const encodedId = ataraxia_transport_1.encodeId(id);
            const node = __classPrivateFieldGet(this, _Network_nodes, "f").get(encodedId);
            if (!node)
                return;
     ...
     */
    get networkId() {
        return ataraxia_transport_1.encodeId(this.networkIdBinary);
    }
    /**
